...
class Tweets extends Component {
  ...
  render() {
    let Link ="https://www.youtube.com/watch?v=piqA5NT-lmg";
    return (
                       ...
                       <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                               <div class="single_tweet">
                                    <iframe src="https://www.youtube.com/watch?v=piqA5NT-lmg" frameborder="0" allowfullscreen width="100%" height="100%;"></iframe>
                               </div>
